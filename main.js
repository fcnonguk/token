...
const myBott = ['ued156c86ffa56024c0acba16f7889e6d','u88cd7ee9fd691d6306e5e19be5d16f69','ua21081256023ab3e3cdd6d722e5a7e00','u2c855ac939e324fc44f1db234adf5206'];//TARO MID LU DISINI SUPAYA BISA PKE COMMAND STAFF

const myBot = ['ued156c86ffa56024c0acba16f7889e6d','u88cd7ee9fd691d6306e5e19be5d16f69','ua21081256023ab3e3cdd6d722e5a7e00','u2c855ac939e324fc44f1db234adf5206'];//TARO MID LU DISINI
...
let { listMember } = await this.searchGroup(seq.to);
     const mentions = await this.mention(listMember);
        ...
        if(txt == 'bye') {
           if(!isAdminOrBot(seq.from) || !isStaffOrBot(seq.from)){
          let txt = await this._sendMessage(seq, 'Kami Dari One Piece Team Bot Protect Mengucapkan Terima Kasih Atas Groupnya Dan Kami Izin Leave~');
